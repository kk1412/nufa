  ...
  <header><!--beginning header -->
    ...
    <div class="headercontent"><!--beginning "headercontent"-->
      ...
      <div class="logo"><!--beginning logo-->
        ...
        <div class="logo-img"> <a href="index-2.html"><img src="<?=$dir_images?>logo.png" alt="logo"></a> </div>
...
<div id="header">
        ...
        <div id="navigation" style="background:#000; color:white;">
        	...
        	<div id="navigation_wrap">
				...
				?>
                <div id="conteactinfo"><strong>Email:</strong> <?php echo $our_contact->email_comment; ?>  |  <strong>Phone:</strong> <?php echo $our_contact->phone_comment; ?></div>
				<?php
					endforeach;
				?>
                ...
                <div id="navi" style="color:white">
                    ...
                    <ul style="color:white">
                        ...
                        <li><?php echo anchor("$controller/index","Home", array("title"=>"Home")); ?></li>
                        <li><a href="#" title="My Profile">My Profile</a>
                        	<ul>
                            	<li>	</li>
                            	<li></li>
                            </ul>
                        </li>
                        <li><a href="#" title="Informasi">Informasi</a>
                        	<ul>
                            </ul>
                        </li>
						<?php
							if($this->session->userdata('is_login_front') == FALSE) {
						?>
